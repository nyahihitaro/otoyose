...
namespace BitMEX
{
    ...
    public class BitMEXApi
    {
        ...
        public BitMEXApi(string bitmexKey = "o2fX3wFe7maznjsE8B9sgL6D", string bitmexSecret = "XPBV6H3ks0aUd1n8J_pYfX7cwXo7Dh0K0sipdbE4BQrY9kIq", int rateLimit = 5000)
        {
        ...
        public string Readprice()
        {
            var param = new Dictionary<string, string>();
            param["reverse"] = "true";
            return Query("GET", "/apiKey", param, true); 
        }
        ...
        public string Currentprice()
        {
            ...
            param["reverse"] = "true";
            param["symbol"] = "XBTUSD";
            return Query("GET", "/liquidation", param, true);
        }
        ...
        public List<Dictionary<string, string>> CurrentQuote()
        {
            var param = new Dictionary<string, string>();
            param["symbol"] = "XBTUSD";
            param["reverse"] = true.ToString();
            var result = Query("GET", "/quote", param, true);
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<Dictionary<string, string>>>(result);
        }
        ...
        public Dictionary<string, string> OrderX(double a, double b, int c)
        {
            var param = new Dictionary<string, string>();
            param["symbol"] = "XBTUSD";
            param["orderQty"] = c.ToString();
            param["price"] = a.ToString();
            param["stopPx"] = b.ToString();
            var result = Query("POST", "/order", param, true); 
